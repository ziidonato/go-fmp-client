...
// GetHistoricalSectorPerformance retrieves historical sector performance data
func (c *Client) GetHistoricalSectorPerformance(sector, from, to, exchange string) ([]HistoricalSectorPerformanceResponse, error) {
	if sector == "" {
